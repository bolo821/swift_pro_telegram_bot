...
import { sendError } from "../../wallet/pvkey.mnemonic.multi.wallet.generate.listener.js";
import { AffiliateService } from "../../../../service/affiliate.service.js";
import { affiliateEarningsSummaryMarkup, affiliateMainMenu } from "../../../../utils/inline.markups.js";
import { affiliateEarningsSummary, affiliateLinkCreated } from "../../../../utils/messages.js";
import { AFFILIATE_RENAME_LISTENER } from "../../../../utils/common.js";
...
listener.enter(async (ctx: any) => {
    ...
    try {
        const ret = await ctx.telegram.sendMessage(ctx.chat.id, "what would you like to name this affiliate link? 32 letters max, only numbers and letters", {
            ...
            reply_markup: {
                force_reply: true,
                input_field_placeholder: 'Swiftbot'
            }
        })
