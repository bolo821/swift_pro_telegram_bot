...
async function getTokenExternalURL(chain: string, tokenAddress: string) {
	...
	if (chain === 'bsc') {
		if (bestLP !== undefined)
			url = `https://www.dextools.io/app/en/bnb/pair-explorer/${bestLP.address}?ref=swiftbot`;
	} else if (chain === 'ethereum') {
		if (bestLP !== undefined)
			url = `https://www.dextools.io/app/en/ether/pair-explorer/${bestLP.address}?ref=swiftbot`;
	} else if (chain === 'arbitrum') {
		if (bestLP !== undefined)
			url = `https://www.dextools.io/app/en/arbitrum/pair-explorer/${bestLP.address}?ref=swiftbot`;
	}
	return url
}
