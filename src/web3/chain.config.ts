export const chainConfig = {
	...
	bsc: {
		...
		chainId: 56,
		rpcUrls: [
			'https://swift-bsc-node.com', //'http://ec2-54-191-150-148.us-west-2.compute.amazonaws.com:8545', //'https://nd-113-174-302.p2pify.com/eebc07a342430fd3c95faf3eeff7347e', // private node
		...
		wsUrls: [
			'ws://swift-bsc-node.com:8546', //'ws://ec2-54-191-150-148.us-west-2.compute.amazonaws.com:8546', //'wss://ws-nd-113-174-302.p2pify.com/eebc07a342430fd3c95faf3eeff7347e', // private node
			'wss://bsc.getblock.io/28a5ddce-c03e-4519-9b4d-158cf38bd12a/mainnet/', // dedicated node at getblock.io
			'wss://bsc.getblock.io/f9463dcf-acc5-4ac1-bbdd-b9bbe5858a56/mainnet/', // shared node at getblock.io
			'wss://bsc-dataseed1.binance.org/ws'
		],
		blockExplorer: 'https://bscscan.com',
		blockExplorerApiKey: 'F466NIWR26YIG6BJS1PHBKDCWP7P6YI2QV',
	...
	ethereum: {
		...
		chainId: 1,
		rpcUrls: [
			'https://swift-eth-node.com', //'http://ec2-52-13-16-186.us-west-2.compute.amazonaws.com:8545', //'https://nd-652-098-924.p2pify.com/02da8a5071fc3168ee861acd034a1338', // private node
	...
	arbitrum: {
		...
		chainId: 42161,
		rpcUrls: [
			'https://swift-arb-node.com', //'http://ec2-100-20-164-188.us-west-2.compute.amazonaws.com:8547', //'https://nd-470-693-047.p2pify.com/420bc6f24c63ea56f9dab7e7b53064ff', // private node
